...
const skinData = {
  ...
  "service-provider": {
    ...
    services: [
      { icon: HandHeart, title: "NDIS Support Coordination", desc: "We work with support coordinators to implement NDIS plans effectively, ensuring participants receive the right services.", number: "01" },
      { icon: Home, title: "Aged Care Package Delivery", desc: "Reliable delivery of Home Care Package services with full documentation, compliance, and regular care reviews.", number: "02" },
      { icon: Users, title: "Collaborative Care Planning", desc: "Joint care planning with your team, ensuring all providers are aligned on client goals, preferences, and progress.", number: "03" },
      { icon: Calendar, title: "Referral & Intake", desc: "Fast, streamlined referral processing. We acknowledge referrals within 24 hours and provide clear next steps.", number: "04" },
      { icon: Brain, title: "Progress Reporting", desc: "Detailed, regular reporting on client outcomes, goal progress, and any concerns, keeping you fully informed.", number: "05" },
      { icon: Heart, title: "Crisis & Short-Notice Support", desc: "When urgent care is needed, our responsive team mobilises quickly to ensure continuity and safety.", number: "06" },
    ],
    accent: "#1d4ed8",
    accentBg: "#eff6ff",
