...
const skinData = {
  ...
  "service-provider": {
    ...
    services: [
      ...
      { icon: Calendar, title: "Roster & Scheduling", desc: "Build dynamic rosters, match the right workers to the right clients, manage availability, and push real-time shift notifications.", detail: "Rostering is one of the most time-consuming tasks in care. Our intelligent scheduling engine considers worker qualifications, client preferences, travel times, and availability to suggest optimal rosters. Workers receive shift notifications via the mobile app, and last-minute changes are handled smoothly with automatic reallocation and client notification." },
